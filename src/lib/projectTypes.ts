...
export const PROJECT_TYPES: ProjectTypeInfo[] = [
  ...
  },
  {
    ...
    desc: "Alcance, controles, hallazgos y recomendaciones. Markdown puro.",
    template: "documento-libre",
    usesFindings: false,
    exam: false,
    family: "narrative",
  ...
  {
    value: "cumplimiento",
    label: "Cumplimiento / GRC",
    icon: "ti-shield-check",
    desc: "Gap analysis frente a ISO 27001, NIST CSF, CIS. Markdown puro.",
    template: "documento-libre",
    usesFindings: false,
    exam: false,
    family: "narrative",
  },
  {
    ...
    desc: "Activos, amenazas, analisis y tratamiento de riesgos. Markdown puro.",
    template: "documento-libre",
    usesFindings: false,
    exam: false,
    family: "narrative",
  },
  {
    ...
    icon: "ti-crosshair",
    desc: "Hipotesis, TTPs (ATT&CK), hallazgos y detecciones. Markdown puro.",
    template: "documento-libre",
    usesFindings: false,
    exam: false,
    family: "narrative",
