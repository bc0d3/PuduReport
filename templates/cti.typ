// Plantilla "Inteligencia de amenazas (CTI)" de PuduReport.
//
// Informe de threat intelligence: portada con kicker propio, indice y el cuerpo
// como un unico lienzo markdown. Sin tabla de hallazgos. Deriva de la plantilla
// de documento libre; solo cambia la identidad de la portada.
//
...
#let cover() = {
  ...
  if ws.branding.cover_layout == "canvas" and ws.branding.at("cover_elements", default: ()).len() > 0 {
    ...
    align(left + horizon)[
      ...
      #text(size: 11pt, weight: "bold", tracking: 3pt, fill: ct(brand))[INTELIGENCIA DE AMENAZAS]
      #v(0.3cm)
